...
//includes = aynı değerden üretmesin ama her değerden üretsin
var pts = [];
while(pts.length < 254){
    while(pts.includes(val = Math.floor(Math.random() * 255)));
    pts.push(val);
}
//ilk indis ile son indisi eşitleme
pts.push(pts[0]);

var lerp = (a,b,t) => a + (b-a) * (1-Math.cos(t * Math.PI))/2;

//daha az sayıyla daha çok çizgi çizmek
var noise = x => {
    x = x * 0.01 % 254;
...
//renkler
var bgcolor = "#907FA4"; // mor
var forecolor = "#476072"; // gri
var linecolor ="#334257"; // lacivert
var linewidth = 5;
var offset = -10;
var yRatio = .3;
var t = 0;
...
//çizim
function draw(){
    // 0-1 arası sayı üretmek (ivmeli)
    // -1 hız yapıp yapmadığı, 0 olursa durur
